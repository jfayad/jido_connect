defmodule Jido.Connect.Google.Calendar.Client.Channels do
  @moduledoc "Google Calendar notification channels API boundary."
  ...
  def stop_channel(%{channel_id: channel_id, resource_id: resource_id} = params, access_token)
    ...
    access_token
    |> Transport.request()
    |> Req.post(url: "/v3/channels/stop", json: Params.stop_channel_body(params))
