defmodule Jido.Connect.Google.Analytics.Metric do
  @moduledoc "Normalized Google Analytics metric descriptor or row value."
  ...
  @schema Zoi.struct(
            ...
            %{
              ...
              expression: Zoi.string() |> Zoi.nullish() |> Zoi.optional(),
              deprecated_api_names: Zoi.list(Zoi.string()) |> Zoi.default([]),
              blocked_reasons: Zoi.list(Zoi.string()) |> Zoi.default([]),
