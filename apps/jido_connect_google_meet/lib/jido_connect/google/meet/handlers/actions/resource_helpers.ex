defmodule Jido.Connect.Google.Meet.Handlers.Actions.ResourceHelpers do
  @moduledoc false

  alias Jido.Connect.{Data, Error}
  alias Jido.Connect.Google.Meet.Client

  def fetch_client(%{google_meet_client: client}) when is_atom(client), do: {:ok, client}
  ...
  defp invalid_field(field, reason) do
    validation_error("Google Meet #{field} must be a non-empty string",
      reason: reason,
      details: %{field: field}
    )
  end
