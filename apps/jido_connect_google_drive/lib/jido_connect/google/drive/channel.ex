defmodule Jido.Connect.Google.Drive.Channel do
  @moduledoc "Normalized Google Drive push notification channel metadata."
  ...
  @schema Zoi.struct(
            ...
            %{
              ...
              payload?: Zoi.boolean() |> Zoi.nullish() |> Zoi.optional(),
